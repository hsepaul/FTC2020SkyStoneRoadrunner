...
public class DriveForwardHeavySkyStonewithSlideRight extends BasicCommand {
    ...
    boolean coast = false;
    public DriveForwardHeavySkyStonewithSlideRight(double targetPosition, int test, double spd, double targetHeading){
    ...
    public DriveForwardHeavySkyStonewithSlideRight(double targetPosition, int test, double spd, double targetHeading, boolean coast){
