...
public class Red1AutonSkyStoneTurnPlatform extends RedAutonSkyStone {
    public void addFinalCommands() {
        commands.add(new DriveSidewaysSkyStoneMecanumNoSkystones(12,DriveSidewaysSkyStoneMecanumNoSkystones.XGREATERTHAN,.85,0));
        ...
        commands.add(new DriveForwardHeavySkyStonewithSlideLeft(-20, DriveForwardHeavySkyStonewithSlideRight.XLESSTHAN,-.75,0));
        commands.add(new ResetDriveEncoders());
        commands.add(new WaitForTime(500));
