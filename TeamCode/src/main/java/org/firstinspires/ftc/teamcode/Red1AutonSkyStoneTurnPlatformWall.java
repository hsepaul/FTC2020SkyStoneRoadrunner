...
public class Red1AutonSkyStoneTurnPlatformWall extends RedAutonSkyStone {
    public void addFinalCommands() {
        ...
        commands.add(new DriveForwardHeavySkyStonewithSlideLeft(-20, DriveForwardHeavySkyStonewithSlideLeft.XLESSTHAN,-.65,0, 8000));
        commands.add(new WaitForTime(500));
        commands.add(new ResetDriveEncoders());
        ...
        group.addCommand(new DriveSidewaysSkyStoneMecanumNoSkystones(13,DriveSidewaysSkyStoneMecanumNoSkystones.XGREATERTHAN,.65,90, 5000));
        commands.add(group);

        commands.add(new WaitForTime(500));
        commands.add(new ResetDriveEncoders());

        commands.add(new DriveForwardSkyStone(-13,DriveForwardSkyStone.XLESSTHAN,-.5,90, 4000));
        commands.add(new WaitForTime(500));
        commands.add(new ResetDriveEncoders());
