...
public class DriveForwardHeavySkyStoneBlue extends BasicCommand {
    ...
    boolean coast = false;
    public DriveForwardHeavySkyStoneBlue(double targetPosition, int test, double spd, double targetHeading){
    ...
    public DriveForwardHeavySkyStoneBlue(double targetPosition, int test, double spd, double targetHeading, boolean coast){
        this(targetPosition,test,spd,targetHeading);
        this.coast=coast;
    }

    public DriveForwardHeavySkyStoneBlue(double dist) {
